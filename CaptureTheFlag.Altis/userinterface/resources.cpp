class CaptureTheFlag_3DEN_ctrlDefault
{
	access=0;
	idc=-1;
	style=0;
...
class CaptureTheFlag_3DEN_ctrlDefaultText: CaptureTheFlag_3DEN_ctrlDefault
{
	sizeEx="4.32 * (1 / (getResolution select 3)) * pixelGrid * 0.5";
	font="RobotoCondensedLight";
	shadow=1;
};
class CaptureTheFlag_3DEN_ctrlDefaultButton: CaptureTheFlag_3DEN_ctrlDefaultText
{
	soundClick[]=
	{
...
class CaptureTheFlag_3DEN_ctrlStatic: CaptureTheFlag_3DEN_ctrlDefaultText
{
	type=0;
...
class CaptureTheFlag_3DEN_ctrlStaticPicture: CaptureTheFlag_3DEN_ctrlStatic
{
	style=48;
};
class CaptureTheFlag_3DEN_ctrlStaticPictureKeepAspect: CaptureTheFlag_3DEN_ctrlStaticPicture
{
	style="0x30 + 0x800";
};
class CaptureTheFlag_3DEN_ctrlStaticPictureTile: CaptureTheFlag_3DEN_ctrlStatic
{
	style=144;
};
class CaptureTheFlag_3DEN_ctrlStaticFrame: CaptureTheFlag_3DEN_ctrlStatic
{
	style=64;
};
class CaptureTheFlag_3DEN_ctrlStaticLine: CaptureTheFlag_3DEN_ctrlStatic
{
	style=176;
};
class CaptureTheFlag_3DEN_ctrlStaticMulti: CaptureTheFlag_3DEN_ctrlStatic
{
	style="0x10 + 0x200";
};
class CaptureTheFlag_3DEN_ctrlStaticBackground: CaptureTheFlag_3DEN_ctrlStatic
{
	colorBackground[]={0.2,0.2,0.2,1};
};
class CaptureTheFlag_3DEN_ctrlStaticOverlay: CaptureTheFlag_3DEN_ctrlStatic
{
	colorBackground[]={0,0,0,0.5};
};
class CaptureTheFlag_3DEN_ctrlStaticTitle: CaptureTheFlag_3DEN_ctrlStatic
{
	moving=1;
	colorBackground[]=
	{
...
class CaptureTheFlag_3DEN_ctrlStaticFooter: CaptureTheFlag_3DEN_ctrlStatic
{
	colorBackground[]={0,0,0,0.30000001};
};
class CaptureTheFlag_3DEN_ctrlStaticBackgroundDisable: CaptureTheFlag_3DEN_ctrlStatic
{
	x=-4;
	y=-2;
	w=8;
...
class CaptureTheFlag_3DEN_ctrlStaticBackgroundDisableTiles: CaptureTheFlag_3DEN_ctrlStaticPictureTile
{
	x=-4;
	y=-2;
	w=8;
...
class CaptureTheFlag_3DEN_ctrlButton: CaptureTheFlag_3DEN_ctrlDefaultButton
{
	type=1;
	style="0x02 + 0xC0";
...
class CaptureTheFlag_3DEN_ctrlButtonPicture: CaptureTheFlag_3DEN_ctrlButton
{
	style="0x02 + 0x30";
};
class CaptureTheFlag_3DEN_ctrlButtonPictureKeepAspect: CaptureTheFlag_3DEN_ctrlButton
{
	style="0x02 + 0x30 + 0x800";
};
class CaptureTheFlag_3DEN_ctrlButtonOK: CaptureTheFlag_3DEN_ctrlButton
{
	default=1;
	idc=1;
	text="$STR_DISP_OK";
};
class CaptureTheFlag_3DEN_ctrlButtonCancel: CaptureTheFlag_3DEN_ctrlButton
{
	idc=2;
	text="$STR_DISP_CANCEL";
};
class CaptureTheFlag_3DEN_ctrlButtonClose: CaptureTheFlag_3DEN_ctrlButtonCancel
{
	text="$STR_DISP_CLOSE";
};
class CaptureTheFlag_3DEN_ctrlButtonToolbar: CaptureTheFlag_3DEN_ctrlButtonPictureKeepAspect
{
	colorBackground[]={0,0,0,0};
	colorBackgroundDisabled[]={0,0,0,0};
};
class CaptureTheFlag_3DEN_ctrlButtonSearch: CaptureTheFlag_3DEN_ctrlButton
{
	style="0x02 + 0x30 + 0x800";
...
class CaptureTheFlag_3DEN_ctrlButtonExpandAll: CaptureTheFlag_3DEN_ctrlButtonToolbar
{
	style="0x02 + 0x30 + 0x800";
	text="\a3\3DEN\Data\Displays\Display3DEN\tree_expand_ca.paa";
	tooltip="$STR_3DEN_ctrlButtonExpandAll_text";
};
class CaptureTheFlag_3DEN_ctrlButtonCollapseAll: CaptureTheFlag_3DEN_ctrlButtonToolbar
{
	style="0x02 + 0x30 + 0x800";
	text="\a3\3DEN\Data\Displays\Display3DEN\tree_collapse_ca.paa";
	tooltip="$STR_3DEN_ctrlButtonCollapseAll_text";
};
class CaptureTheFlag_3DEN_ctrlButtonFilter: CaptureTheFlag_3DEN_ctrlButton
{
	colorBackground[]={0,0,0,0};
	colorBackgroundDisabled[]={0,0,0,0};
...
class CaptureTheFlag_3DEN_ctrlEdit: CaptureTheFlag_3DEN_ctrlDefaultText
{
	type=2;
	colorBackground[]={0,0,0,0.5};
	text="";
...
class CaptureTheFlag_3DEN_ctrlEditMulti: CaptureTheFlag_3DEN_ctrlEdit
{
	style=16;
};
class CaptureTheFlag_3DEN_ctrlSliderV: CaptureTheFlag_3DEN_ctrlDefault
{
	type=3;
	style=0;
	color[]={0,0,0,1};
...
class CaptureTheFlag_3DEN_ctrlSliderH: CaptureTheFlag_3DEN_ctrlSliderV
{
	style=1024;
};
class CaptureTheFlag_3DEN_ctrlCombo: CaptureTheFlag_3DEN_ctrlDefaultText
{
	type=4;
...
class CaptureTheFlag_3DEN_ctrlComboToolbar: CaptureTheFlag_3DEN_ctrlCombo
{
	colorBackground[]={0.050000001,0.050000001,0.050000001,1};
	colorSelectBackground[]=
	{
...
class CaptureTheFlag_3DEN_ctrlListbox: CaptureTheFlag_3DEN_ctrlDefaultText
{
	type=5;
	style="0x00 + 0x10";
	colorBackground[]={0,0,0,0.5};
...
class CaptureTheFlag_3DEN_ctrlToolbox: CaptureTheFlag_3DEN_ctrlDefaultText
{
	type=6;
	style=2;
	colorBackground[]={0,0,0,0.5};
...
class CaptureTheFlag_3DEN_ctrlToolboxPicture: CaptureTheFlag_3DEN_ctrlToolbox
{
	style="0x02 + 0x30";
};
class CaptureTheFlag_3DEN_ctrlToolboxPictureKeepAspect: CaptureTheFlag_3DEN_ctrlToolbox
{
	style="0x02 + 0x30 + 0x800";
};
class CaptureTheFlag_3DEN_ctrlCheckboxes: CaptureTheFlag_3DEN_ctrlDefaultText
{
	type=7;
	colorBackground[]={0,0,0,0.5};
	colorText[]={1,1,1,1};
...
class CaptureTheFlag_3DEN_ctrlCheckboxesCheckbox: CaptureTheFlag_3DEN_ctrlCheckboxes
{
	style=48;
	strings[]=
	{
...
class CaptureTheFlag_3DEN_ctrlProgress: CaptureTheFlag_3DEN_ctrlDefault
{
	type=8;
...
class CaptureTheFlag_3DEN_ctrlHTML: CaptureTheFlag_3DEN_ctrlDefaultText
{
	type=9;
	colorBackground[]={0,0,0,0};
	colorText[]={1,1,1,1};
...
class CaptureTheFlag_3DEN_ctrlActiveText: CaptureTheFlag_3DEN_ctrlDefaultButton
{
	type=11;
	text="";
	color[]=
...
class CaptureTheFlag_3DEN_ctrlActivePicture: CaptureTheFlag_3DEN_ctrlActiveText
{
	style=48;
	color[]={1,1,1,1};
};
class CaptureTheFlag_3DEN_ctrlActivePictureKeepAspect: CaptureTheFlag_3DEN_ctrlActiveText
{
	style="0x30 + 0x800";
};
class CaptureTheFlag_3DEN_ctrlTree: CaptureTheFlag_3DEN_ctrlDefaultText
{
	type=12;
	colorBorder[]={0,0,0,1};
	colorLines[]={0,0,0,0};
...
class CaptureTheFlag_3DEN_ctrlStructuredText: CaptureTheFlag_3DEN_ctrlDefaultText
{
	type=13;
	colorBackground[]={0,0,0,0};
...
class CaptureTheFlag_3DEN_ctrlControlsGroup: CaptureTheFlag_3DEN_ctrlDefault
{
	type=15;
	style=16;
	x=0;
...
class CaptureTheFlag_3DEN_ctrlControlsGroupNoScrollbars: CaptureTheFlag_3DEN_ctrlControlsGroup
{
...
class CaptureTheFlag_3DEN_ctrlControlsGroupNoHScrollbars: CaptureTheFlag_3DEN_ctrlControlsGroup
{
	class HScrollbar: HScrollBar
	{
		height=0;
...
class CaptureTheFlag_3DEN_ctrlControlsGroupNoVScrollbars: CaptureTheFlag_3DEN_ctrlControlsGroup
{
	class VScrollbar: VScrollBar
	{
		width=0;
...
class CaptureTheFlag_3DEN_ctrlShortcutButton: CaptureTheFlag_3DEN_ctrlDefaultButton
{
	type=16;
	style=192;
	colorBackground[]={0,0,0,1};
...
class CaptureTheFlag_3DEN_ctrlShortcutButtonOK: CaptureTheFlag_3DEN_ctrlShortcutButton
{
	default=1;
	idc=1;
	text="$STR_DISP_OK";
};
class CaptureTheFlag_3DEN_ctrlShortcutButtonCancel: CaptureTheFlag_3DEN_ctrlShortcutButton
{
	idc=2;
	text="$STR_DISP_CANCEL";
};
class CaptureTheFlag_3DEN_ctrlShortcutButtonSteam: CaptureTheFlag_3DEN_ctrlShortcutButton
{
...
class CaptureTheFlag_3DEN_ctrlXListbox: CaptureTheFlag_3DEN_ctrlDefaultText
{
	type=42;
...
class CaptureTheFlag_3DEN_ctrlXSliderV: CaptureTheFlag_3DEN_ctrlDefault
{
	type=43;
	style=0;
...
class CaptureTheFlag_3DEN_ctrlXSliderH: CaptureTheFlag_3DEN_ctrlXSliderV
{
	style=1024;
};
class CaptureTheFlag_3DEN_ctrlMenu: CaptureTheFlag_3DEN_ctrlDefaultText
{
	type=46;
	font="RobotoCondensedLight";
	colorBorder[]={0,0,0,0};
...
class CaptureTheFlag_3DEN_ctrlMenuStrip: CaptureTheFlag_3DEN_ctrlMenu
{
	type=47;
...
class CaptureTheFlag_3DEN_ctrlObject
{
};
class CaptureTheFlag_3DEN_ctrlObjectContainer: CaptureTheFlag_3DEN_ctrlObject
{
};
class CaptureTheFlag_3DEN_ctrlObjectZoom: CaptureTheFlag_3DEN_ctrlObject
{
};
class CaptureTheFlag_3DEN_ctrlMap: CaptureTheFlag_3DEN_ctrlDefault
{
	type=101;
	style=48;
	x="safezoneXAbs";
...
class CaptureTheFlag_3DEN_ctrlMapEmpty: CaptureTheFlag_3DEN_ctrlMap
{
...
class CaptureTheFlag_3DEN_ctrlMapMain: CaptureTheFlag_3DEN_ctrlMap
{
};
class CaptureTheFlag_3DEN_ctrlListNBox: CaptureTheFlag_3DEN_ctrlDefaultText
{
	type=102;
	style="0x00 + 0x10";
	colorSelectBackground[]=
...
class CaptureTheFlag_3DEN_ctrlCheckbox: CaptureTheFlag_3DEN_ctrlDefault
{
	type=77;
	checked=0;
...
class CaptureTheFlag_3DEN_ctrlCheckboxToolbar: CaptureTheFlag_3DEN_ctrlCheckbox
{
	color[]={1,1,1,1};
...
class CaptureTheFlag_3DEN_ctrlCheckboxBaseline: CaptureTheFlag_3DEN_ctrlCheckbox
{
...
class CaptureTheFlag_3DEN_ctrlControlsGroupHighlight: CaptureTheFlag_3DEN_ctrlControlsGroupNoScrollbars
{
	class Controls
	{
		class TL: CaptureTheFlag_3DEN_ctrlStaticPicture
		{
			idc=313130;
			text="\a3\3DEN\Data\ControlsGroups\Highlight\highlight_TL_ca.paa";
			colorText[]={0,1,1,1};
		};
		class TM: CaptureTheFlag_3DEN_ctrlStaticPicture
		{
			idc=313131;
			text="\a3\3DEN\Data\ControlsGroups\Highlight\highlight_TM_ca.paa";
			colorText[]={0,1,1,1};
		};
		class TR: CaptureTheFlag_3DEN_ctrlStaticPicture
		{
			idc=313132;
			text="\a3\3DEN\Data\ControlsGroups\Highlight\highlight_TR_ca.paa";
			colorText[]={0,1,1,1};
		};
		class ML: CaptureTheFlag_3DEN_ctrlStaticPicture
		{
			idc=313133;
			text="\a3\3DEN\Data\ControlsGroups\Highlight\highlight_ML_ca.paa";
			colorText[]={0,1,1,1};
		};
		class MR: CaptureTheFlag_3DEN_ctrlStaticPicture
		{
			idc=313134;
			text="\a3\3DEN\Data\ControlsGroups\Highlight\highlight_MR_ca.paa";
			colorText[]={0,1,1,1};
		};
		class BL: CaptureTheFlag_3DEN_ctrlStaticPicture
		{
			idc=313135;
			text="\a3\3DEN\Data\ControlsGroups\Highlight\highlight_BL_ca.paa";
			colorText[]={0,1,1,1};
		};
		class BM: CaptureTheFlag_3DEN_ctrlStaticPicture
		{
			idc=313136;
			text="\a3\3DEN\Data\ControlsGroups\Highlight\highlight_BM_ca.paa";
			colorText[]={0,1,1,1};
		};
		class BR: CaptureTheFlag_3DEN_ctrlStaticPicture
		{
			idc=313137;
...
class CaptureTheFlag_3DEN_ctrlControlsGroupTutorial: CaptureTheFlag_3DEN_ctrlControlsGroupNoScrollbars
{
	w="(	80 + 1) * (pixelW * pixelGrid * 	0.50)";
	h=0;
	class Controls
	{
		class Shadow: CaptureTheFlag_3DEN_ctrlStatic
		{
			idc=323231;
			x="3 * pixelW";
			y="3 * pixelH";
		...
		class Background: CaptureTheFlag_3DEN_ctrlStatic
		{
			idc=323232;
			w="80 * (pixelW * pixelGrid * 	0.50)";
			h="40 * (pixelH * pixelGrid * 	0.50)";
		...
		class Page: CaptureTheFlag_3DEN_ctrlStatic
		{
			idc=323234;
			style=2;
		...
		class ButtonClose: CaptureTheFlag_3DEN_ctrlActivePicture
		{
			idc=323235;
		...
		class ButtonBack: CaptureTheFlag_3DEN_ctrlActivePicture
		{
			idc=323236;
